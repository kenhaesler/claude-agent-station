...
| `dashboard/backend/requirements-lock.txt` | Fully pinned (`==`) lock file generated by `pip-compile`, including transitive deps. Production and CI install from this. Do not hand-edit. |
