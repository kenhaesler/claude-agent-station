type Page = 'dashboard' | 'projects' | 'plans' | 'plan-detail' | 'runs' | 'run-detail' | 'logs' | 'config' | 'system';
...
function parseHash(): Route {
  ...
  const validPages: Page[] = ['dashboard', 'projects', 'plans', 'runs', 'logs', 'config', 'system'];
